...
I now understand the use of version control and repositories. I have never used them before mainly because I always worked by myself.
2. Did you learn anything new about web design (i.e., using media, color, fonts)? i understand the use of CSS and how detailed it can be. It is much more exact than just some inline styling. The two "recipes" that I used to create the index, contact and photo pages were amazing CSS examples. This is much more complicated than Bootstrap. Bootstrap was disappointing. I tried to have an arrangement like the photo page with bootstrap but it didn't work. I couldn't get bootstrap to work even for the navbar. I resorted to using your navbar for the photo and documentary pages. 
3. Free Response: Discuss any challenges you had and what you did to overcome them. I was challenged to actually carry out my vision for this website. I scoured the Youtube groups to come up with the best solutions and then followed their cooking recipes. I really like the index and contact pages. I had trouble using the still of the Big Cedar creek and the overlay with the photo gallery. My solution was to use Photoshop and put the color layer over it and apply the blend mode there instead in the CSS. I like the patterned background. It is much more interesting than some solid color. After the movie background, it was hard to come up with something interesting yet not taking away the interest from the photos or the documentaries. Thanks for your course. It opened my eyes to much more possibilities for tasty, amazing pages. 
Sorry, my CSS files are messy. I had to make one for every page since each page required different  styling. 